  ...
  <div>
    ...
    <el-table :data="employees">
     <el-table-column fixed="left" prop="id" label="编号"></el-table-column>
           ...
           <el-table-column  fixed="right" prop="idCard" label="身份证号"></el-table-column>
           <el-table-column  fixed="right" prop="bankCard" label="银行卡号"></el-table-column>
...
export default {
  ...
  methods:{
    ...
    submitHandler(){
      //this.form 对象 ---字符串--> 后台 {type:'employee',age:12}
      // json字符串 '{"type":"employee","age":12}'
      // request.post(url,this.form)
      // 查询字符串 type=employee&age=12
